...
# --- بخش جدید: تست قطعی راه‌اندازی جمینی ---
print("--- STARTING BOT ---")
print("Attempting to configure Gemini AI...")

# در این نسخه، اگر کلید API اشتباه باشد، برنامه کاملاً کرش می‌کند و خطای واضح می‌دهد
...
# توابع اصلی ربات (start, handle_channel_post, button_callback_handler) مثل قبل هستند...
...
def main() -> None:
    ...
    print("AI Translator Bot is running (DEBUG MODE)...")
